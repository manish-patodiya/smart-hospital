                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="case_id" id="case_id">
                                            ...
                                            <?php
                                                ...
                                                <option value="<?php echo $value['case_reference_id']; ?>" <?php if (set_value('case_id') == $value) {
                                                    echo "selected";
                                                }
                                                ?>><?php echo $value['case_reference_id'] . " (" . $value['patient_name'].")" ; ?>
                                                </option>
                                                <?php } ?>
                                        </select>
                        ...
                        <div class="modal-body pt0 pb0">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                                <label><?php echo $this->lang->line("case_id"); ?></label>
                                                <!-- <input type="text" name="case_id" value="<?php echo set_value('case_id'); ?>" id="ecase_id" class="form-control"> -->
                                                <select class="form-control" name="case_id" id="ecase_id" >
                                            <option value selected>Select</option>
                                            <?php
                                                foreach ($case_id as $value) {?>
                                                <option value="<?php echo $value['case_reference_id'] ?>" <?php if (set_value('case_id') == $value) {
...
$('select[name=case_id]').change(delay(function (e) {
    $("#formadd #mother").val('');
    $("#formedit #mother").val('');
    $("#formadd #mother_name").val('');
    $("#formedit #mother_name").val('');
    
    var case_reference_id=$("select[name=case_id]").val();
