...
class Bill extends Admin_Controller
{
    ...
    public function index($case_id)
    {
        ...
        $this->load->view("admin/bill/index1", $data);
    ...
    public function dashboard()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!empty($patient['patient_id'])) {
                redirect('admin/bill/index1/' . $this->input->post('case_id'));
            } else {
    ...
    public function makepayment()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $module_data = array(
                ...
                'lab' => array('lab_billing_id', $this->input->post('module_id')),
    ...
    public function getRadiologyTransaction()
    {
        ...
        $page = $this->load->view("admin/bill/_getRadiologyTransaction1", $data, true);
        echo json_encode(array('status' => 1, 'page' => $page));
    }
...
//=============pathology=====================
    ...
    public function radiology()
    {
        ...
        $this->load->view('layout/header');
        $this->load->view('admin/bill/radiology/radiology1', $data);
        $this->load->view('layout/footer');
    }
