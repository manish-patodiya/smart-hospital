...
?>
<form id="patient_discharge" accept-charset="utf-8" action="<?php echo base_url() ?>admin/bill/add_discharge"
    method="post" class="" enctype="multipart/form-data">

    <input type="hidden" name="opd_id" value="<?php echo $opd_id; ?>" class="form-control">

    <input type="hidden" name="id" value="<?php if (!empty($discharge_card)) {echo $discharge_card['id'];}?>"
        class="form-control">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <?php if ($balance_amount != 0.00) {?>
                <div class=" alert alert-danger">
                    <!-- <?php echo $this->lang->line('please_note_that_before_discharging_the_patient_check_his_bill') ?> -->
                    <?php echo '<span class="pull-left">Pending amount is ' . $balance_amount . " </span> <a data-dismiss='modal' href='#' onclick=\"$('#pay-tab-li').click();addpaymentModal()\" style='color:blue; margin-left:20%;'>&nbspPay here</a>" ?>
                </div>
                <?php } else {?>
                <div class=" alert alert-success">
                    <?php echo 'No due payement'; ?>
                </div>
                <?php }?>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="discharge_date" id="datetimepicker"
                    value="<?php if ((!empty($discharge_card)) && $discharge_card['discharge_date'] != '') {echo $this->customlib->YYYYMMDDHisTodateFormat($discharge_card['discharge_date']);}?>"
    ...
    ?>
                    <option
                        <?php if ((!empty($discharge_card)) && $discharge_card['discharge_status'] == $key) {echo "selected";}?>
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <textarea name="note" id="note"
                    class="form-control"><?php if (!empty($discharge_card)) {echo $discharge_card['note'];}?></textarea>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                <label for="email"><?php echo $this->lang->line('operation'); ?></label>
                <textarea name="operation" id="operation"
                    class="form-control"><?php if (!empty($discharge_card)) {echo $discharge_card['operation'];}?></textarea>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <textarea name="diagnosis" id="diagnosis"
                    class="form-control"><?php if (!empty($discharge_card)) {echo $discharge_card['diagnosis'];}?></textarea>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                <label for="email"><?php echo $this->lang->line('investigation'); ?></label>
                <textarea name="investigations" id="investigations"
                    class="form-control"><?php if (!empty($discharge_card)) {echo $discharge_card['investigations'];}?></textarea>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                <label for="email"><?php echo $this->lang->line('treatment_home'); ?></label>
                <textarea name="treatment_home" id="treatment_home"
                    class="form-control"><?php if (!empty($discharge_card)) {echo $discharge_card['treatment_home'];}?></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="row death_status_div" style="display: none;">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text"
                    value="<?php if ((!empty($discharge_card)) && $discharge_card['death_date'] != '') {echo $this->customlib->YYYYMMDDHisTodateFormat($discharge_card['death_date']);}?>"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="hidden" name="deathrecord_id"
                    value="<?php if (!empty($deathrecord)) {echo $deathrecord['id'];}?>">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <textarea name="death_report" id="death_report"
                    class="form-control"><?php if (!empty($deathrecord)) {echo $deathrecord['death_report'];}?></textarea>
            </div>
        </div>
        <div class="">
            <?php
...
?>
    ...
    <div class="row reffer_div" style="display: none;">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text"
                    value="<?php if ((!empty($discharge_card)) && $discharge_card['refer_date'] != '') {echo $this->customlib->YYYYMMDDHisTodateFormat($discharge_card['refer_date']);}?>"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text"
                    value="<?php if ((!empty($discharge_card)) && $discharge_card['refer_to_hospital'] != '') {echo $discharge_card['refer_to_hospital'];}?>"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text"
                    value="<?php if ((!empty($discharge_card)) && $discharge_card['reason_for_referral'] != '') {echo $discharge_card['reason_for_referral'];}?>"
    ...
    <div class="modal-footer">
        <?php if ($this->rbac->hasPrivilege('opd_patient_discharge', 'can_edit')) {?>
        <button id="add_paymentbtn" type=submit data-loading-text="<?php echo $this->lang->line('processing'); ?>"
            class="btn btn-info pull-right printsavebtn"><i class="fa fa-check-circle"></i>
            <?php echo $this->lang->line('save'); ?></button>
        <?php }?>
        ...
        <!-- <li> -->
        <a class="btn btn-primary " onclick="$('#pay-tab-li').click();" data-dismiss="modal"
...
var download =
    ' <a href="<?php echo site_url('admin/birthordeath/download_deathrecord/' . $deathrecord['id']); ?> "   class="" data-recordId=""  ><i class="fa fa-download"></i> </a>&nbsp; ';
<?php }?>
<?php if ((!empty($discharge_card))) {?>

$('#allpayments_print').html(
    ' <a href="javascript:void(0);"   class="print_dischargecard" data-recordId="<?php echo $discharge_card['id']; ?>" data-case_id="<?php echo $case_id; ?>" ><i class="fa fa-print"></i> </a>&nbsp; ' +
    download);
