...
class Birthordeath extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $case_id = $this->patient_model->getcaseid("female");
    ...
    public function getbirthDatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                $column_first .= "<a href='#' class='btn btn-default btn-xs' data-toggle='tooltip' onclick='printData(" . $value->id . ")'   data-original-title='".$this->lang->line('print')."'><i class='fa fa-print'></i></a>";
    ...
    public function death()
    {
        ...
        $case_id = $this->patient_model->getcaseid("male");
        $data["patients"] = $patients;
        $data["case_id"] = $case_id;
        $data['fields']   = $this->customfield_model->get_custom_fields('death_report', 1);
        $this->load->view("layout/header");
