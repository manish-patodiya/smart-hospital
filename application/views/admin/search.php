...
if ($this->rbac->hasPrivilege('enabled_disabled', 'can_view')) {
    ...
    ?>
                            <button type="submit" class="btn btn-primary pull-right btn-sm mt10 delete_selected"
                                id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> "><i
                                    class="fa fa-trash"></i>
                                <?php echo $this->lang->line('delete_selected'); ?></button>
                            <?php }?>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="clear: both;overflow: hidden;">
                                            ...
                                            <input type="text" id="age_month"
                                                ...
                                                name="age[month]" value="00" class="form-control patient_age_month"
    ...
    ?>><?php echo $value; ?></option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input id="emobileno" autocomplete="off" name="contact" type="text" placeholder=""
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input name="identification_number" placeholder="" id="edit_identification_number"
...
?>
    ...
    ?>
                                                            <option value="<?php echo $mvalue; ?>" <?php if (set_value('marital_status') == $mkey) {
        echo "selected";
    }
