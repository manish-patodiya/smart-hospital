...
class Admin extends Admin_Controller
{
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($value->is_active == 'yes') {
                    ...
                    $info_url[3] = base_url() . 'admin/labtest/getTestReportBatch';
                    $info_url[4] = base_url() . 'admin/pathology/getTestReportBatch';
                    $info_url[5] = base_url() . 'admin/pharmacy/bill';
                    $info_url[6] = base_url() . 'admin/pharmacy/bill1';
    ...
    public function dashboard()
    {
        ...
        $search_cash_income = array('payment_mode' => 'Cash');
        $data['cash_income'] = $this->transaction_model->get_monthTransaction($search_cash_income);
