            ...
            <div class="box border0 mb0">
                ...
                <div class="nav-tabs-custom border0 mb0" id="tabs">
                    <!--<ul class="nav nav-tabs navlistscroll">
                        ...
                        <li>
                            <a href="#medication" class="medication" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fa-medkit" aria-hidden="true"></i>
                                <?php echo $this->lang->line("medication"); ?></a>
                        </li>
                        <?php }?>
                        ...
                        <li>
                            <a href="#prescription" data-toggle="tab" aria-expanded="true"><i
                                ...
                                <?php echo $this->lang->line('prescription'); ?></a>
                        </li>
                        <?php }?>
                        ...
                        <li>
                            <a href="#labinvestigation" data-toggle="tab" aria-expanded="true"><i
                                    class="fas fa-diagnoses"></i>
                                <?php echo $this->lang->line('lab_investigation'); ?></a>
                        </li>
                        <?php }?>
                        ...
                        <li>
                            <a id="pay-tab-li" href="#payment" data-toggle="tab" aria-expanded="true"><i
                        ...
                        <div class="tab-pane tab-content-height active" id="overview">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 border-r">
                                    <div class="box-header border-b mb0 pl-0 pt0 row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="pull-right">
                                            <div class="editviewdelete-icon pt8">
                                                <!-- <a class=" btn btn-primary" href="#"
                                                    onclick="getRecord('<?php echo $ipdid ?>')" data-toggle="tooltip"
                                                    title="<?php echo $this->lang->line('profile') ?>">
                                                    <span class="text-white">Profile</i></span>
                                                </a> -->
                                                <a class=" btn btn-danger " href="#" data-toggle="modal"
                                                    data-target='#myPaymentModal'><span class="text-white">
                                                        <?php $rmn_amt = $ipd_data[0]->amount - $paid_amount;
echo ($rmn_amt < 0 ? 'Advance' : 'Due') . " Amount: " . $currency_symbol . " " . (str_replace('-', '', $rmn_amt));?>
                                                    </span>
                                                </a>
                                                <?php
...
if ($result['is_active'] != 'no') {if ($result['ipd_discharge'] != 'yes') {if ($this->rbac->hasPrivilege('ipd_patient', 'can_edit')) {
    ?>
                                                <!-- <a class=" btn btn-primary " href="#"
                                                    onclick="getEditRecord('<?php echo $ipdid ?>')"
                                                    data-toggle="tooltip"
                                                    title="<?php echo $this->lang->line('edit_profile'); ?>"><span
                                                        class="text-white">Profile</span>
                                                </a> -->
    ...
    if (!$is_discharge) {
        if ($this->rbac->hasPrivilege('ipd_patient_discharge_revert', 'can_view')) {?>
                                                <a data-toggle="tooltip" class="btn btn-danger "
                                                    ...
                                                    href="#"
                                                    title="<?php echo $this->lang->line('discharge_revert') ?>"><span
                                                        class="text-white">Revert Discharge<span></a>
                                                <?php
}}
    if ($this->rbac->hasPrivilege('ipd_patient_discharge', 'can_view')) {?>
                                                <a class="btn btn-success patient_discharge " href="#"
                                                    data-toggle="tooltip"
                                                    title="<?php echo $this->lang->line('patient_discharge'); ?>"><span
                                                        class="text-white">Discharge</span>
                                                </a>
    ...
    if ($result['ipd_discharge'] != 'yes') {
        if ($this->rbac->hasPrivilege('ipd_patient', 'can_delete')) {?>
                                                <a class=" btn btn-danger" href="#"
                                                    onclick="deleteIpdPatient('<?php echo $ipdid ?>')"
                                                    data-toggle="tooltip"
...
?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12"
                                            style="padding:10px;border-left:1px solid gray;">
                                            <div class="align-content-center ">
                                                <table class="table table-bordered" style="margin:0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $this->customlib->getSessionPrefixByType('ipd_no') . $ipdid; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $this->customlib->YYYYMMDDHisTodateFormat($result['date'], $time_format); ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bolds">
                                                        ...
                                                        <td><?php echo $result['bed_name'] . " - " . $result['bedgroup_name'] . " - " . $result['floor_name'] ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                    ...
                                    <!--./row-->
                                    <hr class="hr-panel-heading hr-10" style="margin:0;">
                                        ...
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <h5 class="media-heading"><a
                                                        href="<?php echo base_url(); ?>admin/staff/profile/<?php echo $result['staff_id']; ?>"><?php echo $result['name'] . " " . $result['surname'] . " (" . $result['employee_id'] . ")"; ?></a>
...
foreach ($doctors_ipd as $dkey => $dvalue) {?>
                                        ...
                                        <div class='table-responsive'>
                                            <div class="box-tab-header">
                                                ...
                                                <div class="box-tab-tools">
                                                    ...
                                                    <a href="#"
                                                        class="btn btn-sm btn-primary dropdown-toggle addpayment"
                                                        data-target='#alot_bed' data-toggle="modal"><i
                                                            class="fa fa-plus"></i>
                                                        Change Bed</a>
                                                    <?php }?>
                                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mailbox-name">
                                                        <?php if ($history->from_date != '') {echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($history->from_date));}?>
                                                    </td>
                                                    <td>
                                                        <?php $first_date = new DateTime($history->from_date);
    $second_date = new DateTime($history->to_date ?: 'now');
    $difference = $first_date->diff($second_date);?>
                                                        <?=$this->customlib->getBedTime($difference->m, $difference->d, $difference->h, $difference->i)?>
                                                    </td>
                                                    <td class="mailbox-name">
                                                        <?php if ($history->to_date != '') {echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($history->to_date));}?>
                                                    </td>
                                                    <!-- <td class="mailbox-name">
                                                <?php echo $this->lang->line($history->is_active); ?></td> -->
                                                </tr>
                                                <?php }?>
                                            </tbody>
                                        </table>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="box-header mb10 pl-0">
                                        <div class="table-responsive">
                                            <div class="box-tab-header">
                                                <h3 class="box-tab-title"><?php echo $this->lang->line('charges'); ?>
                                                </h3>
                                                <div class="box-tab-tools">
                                                    <?php if ($this->rbac->hasPrivilege('charges', 'can_add')) {?>
                                                    <?php if ($is_discharge) {?>
                                                    <a href="#"
                                                        class="btn btn-sm btn-primary dropdown-toggle addcharges"
                                            ...
                                            <div class="download_label"><?php echo $this->lang->line('charges'); ?>
                                            </div>
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered">
    ...
    foreach ($charges as $charge) {
        ...
        ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-transform: capitalize;">
                                                                ...
                                                                <div class="bill_item_footer text-muted">
                                                                    <label><?php if ($charge["note"] != '') {echo $this->lang->line('charge_note') . ': ';}?>
                                                                    </label> <?php echo $charge["note"] ?>
                                                                </div>
                                                            </td>
                                                            <td class="text-right">
                                                                <?php echo number_format($charge["amount"], 2) ?>
                                                            </td>
                                                            <td class="text-right white-space-nowrap">
                                                                <a href="javascript:void(0);"
                                                                    class="btn btn-default btn-xs print_charge"
                                                                    data-toggle="tooltip" title=""
                                                                    data-record-id="<?php echo $charge['id']; ?>"
                                                                ...
                                                                <a href='javascript:void(0);'
                                                                    class='btn btn-default btn-xs edit_charge'
                                                                    data-loading-text="<?php echo $this->lang->line('please_wait'); ?>"
                                                                    data-toggle='tooltip'
                                                                    data-record-id='<?php echo $charge['id']; ?>'
                                                                ...
                                                                <a href='javascript:void(0);'
                                                                    data-record-id="<?php echo $charge['id']; ?>"
                                                                    class="btn btn-default btn-xs delete-charge"
                                                                    data-toggle="tooltip" title=""
                                    ...
                                    <div class="box-tab-header">
                                        ...
                                        <div class="box-tab-tools">
                                            <?php if ($this->rbac->hasPrivilege('payment', 'can_add')) {?>
    ...
    if (!empty($payment_details)) {
        ...
        foreach ($payment_details as $payment) {
            ...
            ?>
                                                    <tr>
                                                        <td><?php echo $this->customlib->YYYYMMDDHisTodateFormat($payment['payment_date'], $this->customlib->getHospitalTimeFormat()); ?>
                                                        </td>
            ...
            ?>
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            <a href='<?php echo site_url('admin/transaction/download/' . $payment['id']); ?>'
                                                            ...
                                                            <a href="javascript:void(0)"
                                                                ...
                                                                data-record-id="<?php echo $payment['id'] ?>"
                                                                data-loading-text="<?php echo $this->lang->line('please_wait'); ?>"
                                                                data-toggle="tooltip"
                                                                data-original-title="<?php echo $this->lang->line('print'); ?>"><i
                                                                    class="fa fa-print"></i></a>
                                                            <?php if (!empty($payment["document"])) {?>
                                                            <a href="<?php echo base_url(); ?>admin/payment/download/<?php echo $payment["document"]; ?>"
                                                                class="btn btn-default btn-xs" data-toggle="tooltip"
                                                                title="<?php echo $this->lang->line('download'); ?>">
                                                                <i class="fa fa-download"></i>
                                                            </a>
                                                            <?php }?>
                                                            <?php if ($is_discharge) {if ($this->rbac->hasPrivilege('payment', 'can_delete')) {?>
                                                            <a href="javascript:void(0);"
                                                ...
                                                <tr class="box box-solid total-bg">
                                                    <td colspan="10" class="text-right">
                                                        <?php echo $this->lang->line('total') . " : " . $currency_symbol . " " . amountFormat($total_payment); ?>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                                <?php }?>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <span class="time">
                                                ...
                                                <a class="btn btn-default btn-xs" data-toggle="tooltip" title=""
                                                    onclick="delete_record('<?php echo base_url(); ?>admin/patient/deleteIpdnursenote/<?php echo $value['id']; ?>/<?php echo $value['ipd_id']; ?>', '<?php echo $this->lang->line('delete_message'); ?>')"
                                                    data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                    <i class="fa fa-trash"></i>
                                                </a>
                                            </span>
...
if (!empty($fields_nurse)) {
        ...
        ?>
            ...
            if ($is_discharge) {if ($this->rbac->hasPrivilege('nurse_note', 'can_delete')) { ?>
                                                <a class="btn btn-default btn-xs" data-toggle="tooltip" title=""
                                                    onclick="delete_record('<?php echo base_url(); ?>admin/patient/deletenursenotecomment/<?php echo $cvalue['id']; ?>', '<?php echo $this->lang->line('delete_message'); ?>')"
                                                    data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                    <i class="fa fa-trash"></i>
                                                </a>
                                                <?php }}?>
...
if ($this->rbac->hasPrivilege('consultant_register', 'can_add')) {
    ...
    if (!empty($consultant_register)) {
        foreach ($consultant_register as $consultant_key => $consultant_value) {
            ?>
                                        <tr>
                                            <td><?php echo $this->customlib->YYYYMMDDHisTodateFormat($consultant_value['date'], $this->customlib->getHospitalTimeFormat()); ?>
                                            </td>
                                            <td><?php echo $consultant_value["name"] . " " . $consultant_value["surname"] . " (" . $consultant_value["employee_id"] . ")" ?>
                                            </td>
                                            <td><?php echo nl2br($consultant_value["instruction"]); ?></td>
                                            <td><?php echo $this->customlib->YYYYMMDDTodateFormat($consultant_value['ins_date']); ?>
                                            </td>
            ...
            ?>
                                            <td class="text-right">
                                                ...
                                                <a onclick="editConsultantRegister('<?php echo $consultant_value['id']; ?>')"
                                                ...
                                                <a class="btn btn-default btn-xs" data-toggle="tooltip" title=""
                                                    onclick="delete_record('<?php echo base_url(); ?>admin/patient/deleteIpdPatientConsultant/<?php echo $consultant_value['id']; ?>', '<?php echo $this->lang->line('delete_message'); ?>')"
                                                    data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                    <i class="fa fa-trash"></i>
...
foreach ($timeline_list as $key => $value) {
    ...
    ?>
        ...
        if ($this->rbac->hasPrivilege('ipd_timeline', 'can_edit')) {
            if ($value['generated_users_type'] != 'patient') {
                ?><span class="time"><a onclick="editTimeline('<?php echo $value['id']; ?>')"
                                                        class="defaults-c text-right" data-toggle="tooltip" title=""
                                                        data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a></span>
...
for ($x = 0; $x <= $dosage_count; $x++) {
                if (array_key_exists($x, $mvalue['dose_list'])) {$medicine_id = $mvalue['dose_list'][$x]['pharmacy_id'];
            ...
            ?>
                                            <td class="text-right">
                                                <a href='#' data-toggle='tooltip'
                                                    ...
                                                    onclick='viewdetail("<?php echo $ot_value['id']; ?>")'> <i
    ...
    foreach ($charges as $charge) {
        ...
        ?>
                                        <tr>
                                            ...
                                            <!-- <td class="text-right">
                                                <?php echo "(" . $charge["tax"] . "%) " . $taxamount; ?>
                                            </td> -->
                                            <td class="text-right"><?php echo number_format($charge["amount"], 2) ?>
                                            </td>
                                            <td class="text-right white-space-nowrap">
                                                <a href="javascript:void(0);"
                                                    class="btn btn-default btn-xs print_charge" data-toggle="tooltip"
                                                    title="" data-record-id="<?php echo $charge['id']; ?>"
                                                    data-original-title="<?php echo $this->lang->line('print'); ?>"
                                                    data-loading-text="<?php echo $this->lang->line('please_wait'); ?>">
                                                    <i class="fa fa-print"></i>
                                                </a>
                                                ...
                                                <?php if ($is_discharge) {if ($this->rbac->hasPrivilege('charges', 'can_edit')) {?>
                                                <a href='javascript:void(0);' class='btn btn-default btn-xs edit_charge'
                                                    data-loading-text="<?php echo $this->lang->line('please_wait'); ?>"
                                                    data-toggle='tooltip' data-record-id='<?php echo $charge['id']; ?>'
                                                    title="<?php echo $this->lang->line('edit') ?>"><i
                                                        class='fa fa-pencil'></i></a>
                                                <?php }if ($this->rbac->hasPrivilege('charges', 'can_delete')) {?>
                                                <a href='javascript:void(0);'
                                                    data-record-id="<?php echo $charge['id']; ?>"
                                                    class="btn btn-default btn-xs delete-charge" data-toggle="tooltip"
                                                    title=""
                                                    data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                    <i class="fa fa-trash"></i>
                                                </a>
            ...
            ?>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href='<?php echo site_url('admin/transaction/download/' . $payment['id']); ?>'
                                                    ...
                                                    title='<?php echo $this->lang->line('download'); ?>'><i
                                                        class='fa fa-download'></i></a>
                                                <?php }?>
                                                <a href="javascript:void(0)" class="btn btn-default btn-xs print_trans"
                                                    data-record-id="<?php echo $payment['id'] ?>"
                                                    data-loading-text="<?php echo $this->lang->line('please_wait'); ?>"
                                                    data-toggle="tooltip"
                                                    data-original-title="<?php echo $this->lang->line('print'); ?>"><i
                                    ...
                                    <tr class="box box-solid total-bg">
                                        ...
                                        <td colspan="" class="text-right">
                                            <?php echo $this->lang->line('total') . " : " . $currency_symbol . "" . number_format($total_payment, 2); ?>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <?php }?>
...
if ((isset($doctors_ipd)) && (in_array($dvalue["id"], $ipdarray[1]))) {echo "selected";}?>>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="nurse" style="width: 100%" id="edit_nurse"
                                            ...
                                            <option
                                                <?php if ((isset($nurse_select)) && ($nurse_select == $value["id"])) {echo "selected";}?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <small class="req"> *</small>
                                    <input type="text" value="<?php //echo set_value('email');     ?>" id="date"
...
<div class="modal fade" id="viewModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            ...
            <div class="modal-footer">
                <a class=" btn btn-primary  " href="#" onclick="getEditRecord('<?php echo $ipdid ?>')"
                    data-toggle="tooltip" title="<?php echo $this->lang->line('edit_profile'); ?>"><span
                        class="text-white"> Edit Profile</span>
                </a>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('amount') . " (" . $currency_symbol . ")"; ?></label><small
                                        class="req"> *</small>
                                    <input type="text" name="amount" id="amount" class="form-control" value="<?php $due = $total - $total_payment;
echo $due < 0 ? -($due) : $due?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="checkbox-inline">
                                        <input id="mark_as_refund" value='1' type="checkbox"
                                            <?=$due < 0 ? 'checked' : false?> name="mark_as_refund">
                                        <?php echo 'Mark as refund'; ?> </label>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content modal-media-content">
            ...
            <form id="add_charges" accept-charset="utf-8" method="post" class="ptt10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2" style="display:none !important">
                                        <div class="form-group">
                                            ...
                                            <select name="charge_type" id="add_charge_type" style="width: 100%"
                                                ...
                                                <option value="<?php echo $value->id; ?>"
                                                    <?php echo strtoupper($value->charge_type) == 'IPD' ? "selected" : ""; ?>>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="standard_charge" id="standard_charge"
                                                class="form-control"
                                    ...
                                    <input type="hidden" readonly name="schedule_charge" id="schedule_charge"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 " style="margin-top:5px">
                                        ...
                                        <table class="printablea4">
                                            <input type="hidden" placeholder="Total" value="0" name="apply_charge"
                                                id="apply_charge" style="width: 30%; float: right"
                                                class="form-control total" readonly />
                                            <input type="hidden" placeholder="<?php echo $this->lang->line('tax'); ?>"
                                                name="charge_tax" id="charge_tax" class="form-control charge_tax"
                                                readonly style="width: 70%; float: right;font-size: 12px;" />
                                            <input type="hidden" placeholder="Tax" name="tax" value="0" id="tax"
                                                style="width: 50%; float: right" class="form-control tax" readonly />
                ...
                <div class="modal-footer sticky-footer">
                    <div class="pull-right">
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>"
                            name="charge_data" value="add" class="btn btn-info"><i class="fa fa-check-circle"></i>
...
<div class="modal fade" id="myChargeseditModal" role="dialog" aria-labelledby="myModalLabel">
    ...
    ?>
                                    ...
                                    <input type="hidden" readonly name="schedule_charge" id="editschedule_charge"
                                        placeholder="" class="form-control" value="">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('qty'); ?></label><small class="req">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="note" id="enote" rows="2"
                                                        class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-6" style="margin-top:5px">
                                        ...
                                        <table class="printablea4">
                                            ...
                                            <input type="hidden" placeholder="Total" value="0" name="apply_charge"
                                                ...
                                                class="form-control total" readonly />
                                            <input type="hidden" placeholder="<?php echo $this->lang->line('tax'); ?>"
                                                name="charge_tax" id="editcharge_tax" class="form-control charge_tax"
                                                readonly style="width: 70%; float: right;font-size: 12px;" />
                                            <input type="hidden" placeholder="Tax" name="tax" value="0" id="edittax"
                                                style="width: 50%; float: right" class="form-control tax" readonly />
                                            <tr>
                                                <th><?php echo $this->lang->line('net_amount') . " (" . $currency_symbol . ")"; ?>
                                                </th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="doctor_field" <?php
if ($disable_option == true) {echo "disabled";}?> style="width: 100%" id="editdoctor_field"
                                        class="form-control select2">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php foreach ($doctors as $key => $value) {?>
                                        <option
...
if ($disable_option == true) {echo "disabled";}?> style="width: 100%" id="nurse_field" class="form-control select2">
                                        ...
                                        <option
                                            <?php if ((isset($nurse_select)) && ($nurse_select == $dvalue["id"])) {echo "selected";}?>
                                            value="<?php echo $value["id"] ?>">
                                            <?php echo composeStaffNameByString($value["name"], $value["surname"], $value["employee_id"]); ?>
                                        </option>
                                        <?php }?>
...
<div class="modal fade" id="alot_bed" role="dialog" aria-labelledby="myModalLabel">
                ...
                <div class="modal-body pt0 pb0">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <input name="patient_id" placeholder="" value="<?php echo $result["patient_id"] ?>"
                                    type="hidden" class="form-control" />

                                <input type="hidden" name='ipd_id' value="<?php echo $result['ipdid'] ?>">

                                <input type="hidden" name='oldbedno' value="<?php echo $result['bed_id'] ?>">

                                <input type="hidden" name="case_ref_id"
                                    value='<?php echo $result['case_reference_id'] ?>'>

                                <div class="col-md-12 mb10">
                                    <label><?php echo $this->lang->line('date') ?><small class="req"> *</small></label>
                                    <input type="text" class='datetime form-control' name='change_date'>
                                </div>
    ...
    ?>
                                ...
                                <!-- <div class="col-md-12" style="margin-top: 10px;">
                                    <label><?php echo $this->lang->line('bed') . " " . $this->lang->line('charge'); ?><small
                                            class="req"> *</small></label>
                                    <select class="form-control" onchange="setBedFees(this);" name="charge_id">
                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                        <?php foreach ($bed_charges as $key => $charge) {?>
                                        <option value="<?php echo $charge->id ?>"
                                            charge='<?=$charge->standard_charge?>'>
                                            <?php echo $charge->name . " (" . $charge->standard_charge . ')' ?>
                                        </option>
                                        <?php }?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12" style="margin-top: 10px;">
                                    <label><?php echo $this->lang->line('amount') ?><small class="req">
                                            *</small></label>
                                    <input type="text" name="amount" id="bed_fees" class="form-control">
                                </div> -->
                            </div>
                            <script>
                            function setBedFees(ele) {
                                var charge = $(ele).find('option:selected').attr('charge');
                                $('#bed_fees').val(charge);
                            }
                            </script>
                            <div class="modal-footer">
...
$('#myChargesModal').on('show.bs.modal', function(e) {
    $('#add_charge_type').trigger('change');
});
        ...
        success: function(data) {
            ...
            $.each(data.field_data, function(i, obj) {
                ...
                table_html += "<th><span id='vcustom_name'>" + capitalizeFirstLetter(name) +
                    "</span></th> <td><span id='vcustom_value'>" + field_value +
                    "</span></td>";
            });
...
function getEditRecord(ipdid) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('select[id="patient_consultant"] option[value="' + data.cons_doctor + '"]').attr(
                "selected",
                "selected");
            $('select[id="patient_casualty"] option[value="' + data.casualty + '"]').attr(
                "selected",
                "selected");
            $('select[id="old"] option[value="' + data.patient_old + '"]').attr("selected",
                "selected");
            $('select[id="genders"] option[value="' + data.gender + '"]').attr("selected",
                "selected");
            $('select[id="marital_statuss"] option[value="' + data.marital_status + '"]').attr(
                "selected",
                "selected");
...
function getMedicineDosage(id) {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            $.each(res, function(i, obj) {
                var sel = "";
                div_data += "<option value='" + obj.dosage + "'>" + obj.dosage +
                    "</option>";
...
$(document).on('click', '.add-record', function() {
    ...
    var div = "<input type='hidden' name='rows[]' value='" + prescription_rows +
        ...
        prescription_rows +
        "''> </small></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div><select  class='form-control select2 medicine_dosage' name='dosage_" +
        prescription_rows + "' id='search-dosage" + prescription_rows +
        "'><option value='l'><?php echo $this->lang->line('select'); ?></option></select></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div><select  class='form-control select2 interval_dosage' name='interval_dosage_" +
        prescription_rows + "' id='search-interval-dosage" + prescription_rows +
        "'><option value='<?php echo set_value('interval_dosage_id'); ?>'><?php echo $this->lang->line('select'); ?></option><?php foreach ($intervaldosage as $dkey => $dvalue) {?><option value='<?php echo $dvalue["id"]; ?>'><?php echo $dvalue["name"] ?></option><?php }?></select></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div><select class='form-control select2 duration_dosage' name='duration_dosage_" +
        prescription_rows + "' id='search-duration-dosage" + prescription_rows +
        "'><option value='<?php echo set_value('duration_dosage_id'); ?>'><?php echo $this->lang->line('select') ?></option><?php foreach ($durationdosage as $dkey => $dvalue) {?><option value='<?php echo $dvalue["id"]; ?>'><?php echo $dvalue["name"] ?></option><?php }?></select></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div><textarea style='height:28px' name='instruction_" +
        prescription_rows + "' class=form-control id=description></textarea></div></div></div>";
    var table_row = "<tr id='row" + prescription_rows + "'><td>" + div +
        "</td><td><label class='displayblock'>&nbsp;</label><button type='button' data-row-id='" +
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == "fail") {
                    ...
                    successMsg(data.message);
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/timeline/patient_timeline/' +
                            patient_id,
                        success: function(res) {
...
function editConsultantRegister(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('select[id="editdoctor_field"] option[value="' + data.cons_doctor + '"]').attr(
                "selected",
                "selected");
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#edit_operationtheatre #econsultant_doctorid").select2().select2('val', data
                .consultant_doctor);
            $("#edit_operationtheatre #eoperation_name").select2().select2('val', data
                .operation_id);
        ...
        success: function(res) {
            ...
            medicineTable.find("tbody tr").each(function() {
                ...
                var post_medicine_category_id = $(this).find(
                        "td input.post_medicine_category_id")
                    .val();
                ...
                getMedicine(medicine_category_obj, post_medicine_category_id,
                    post_medicine_id);
...
function view_prescription(id, ipdid, discharged = '') {
    ...
    if (discharged != "yes") {
        $('#edit_deleteprescription').html(
            "<?php if ($this->rbac->hasPrivilege('ipd_prescription', 'can_view')) {?><a href='#prescription' onclick='printprescription(" +
            id +
            ")' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a><?php }?><?php if ($this->rbac->hasPrivilege('ipd_prescription', 'can_edit')) {?><a href='#prescription' onclick='edit_prescription(" +
            id +
            ")' data-target='#edit_prescription'  data-toggle='tooltip' data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php }if ($this->rbac->hasPrivilege('ipd_prescription', 'can_delete')) {?><a onclick='delete_prescription(" +
            id +
            ")'    data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a><?php }?>"
        );
    } else {
        $('#edit_deleteprescription').html(
            "<?php if ($this->rbac->hasPrivilege('ipd_prescription', 'can_view')) {?><a href='#prescription' onclick='printprescription(" +
            id +
            ")'  data-toggle='tooltip' data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a><?php }?>"
        );
    }
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if (res) {
                ...
                var total_charge = (schedule_charge == null) ? standard_charge :
                    schedule_charge;
...
$(document).on('change keyup input paste', '#standard_charge', function() {
    var quantity = $("#qty").val();
    var standard_charge = $(this).val();
    var schedule_charge = $('#schedule_charge').val();
    var tax_percent = $('#charge_tax').val();
    var total_charge = (schedule_charge == "") ? standard_charge : schedule_charge;
    var apply_charge = isNaN(parseFloat(total_charge) * parseFloat(quantity)) ? 0 : parseFloat(
...
function calculate() {
    ...
    var gross_total = parseFloat(total_amount) + parseFloat(other_charge) + parseFloat(tax) - parseFloat(
        discount);
    var net_amount = parseFloat(total_amount) + parseFloat(other_charge) + parseFloat(tax) - parseFloat(
        discount);
...
function revert(patient_id, bedid, ipdid) {
...
function checkbed(patient_id, bedid, ipdid) {
    var v = 'false';
            ...
            success: function(res) {
                if (res.status == "fail") {
                    ...
                    var charge = '<tr id="' + row_id + '"><td>' + data
                        .charge_type_name + '</td><td>' + data.charge_category +
                        '</td><td>' + data.charge_name +
                        '<input type="hidden" name="pre_tax_percentage[]" value="' +
                        data.tax_percentage +
                        '"><input type="hidden" name="pre_charge_id[]" value="' + data
                        .charge_id + '"></td><td>' + data.standard_charge +
                        '<input type="hidden" name="pre_standard_charge[]" value="' +
                        data.standard_charge + '"></td><td>' + data.tpa_charge +
                        '<input type="hidden" name="pre_tpa_charges[]" value="' + data
                        .tpa_charge + '"></td><td>' + data.qty +
                        ...
                        '<input type="hidden" name="pre_net_amount[]" value="' + data
                        .net_amount +
...
$('#myPaymentModal').on('show.bs.modal', function() {
    setTimeout(() => {
        $("#date").data("DateTimePicker").date(moment(new Date).format(datetime_format))
    }, 2000);
})
