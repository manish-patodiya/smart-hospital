            ...
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <li><a href="<?php echo base_url(); ?>admin/labparameter/addlab"
                                class="active"><?php echo $this->lang->line('lab_category'); ?></a></li>
            ...
            <div class="col-md-10">
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('lab_category_list'); ?></h3>
                        <div class="box-tools addmeeting">
                            ...
                            <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm radiology"><i
                                    class="fa fa-plus"></i>
                                <?php echo $this->lang->line('add_lab_category'); ?></a>
                            <?php }?>
                        </div>
                    </div>
                    <div class="box-body">
    ...
    ?>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="<?php echo base_url(); ?>admin/labparameter/delete/<?php echo $lab['id'] ?>"
                                                class="btn btn-default btn-xs" data-toggle="tooltip"
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"> <?php echo $this->lang->line('add_lab_category'); ?></h4>
            </div>

            <form id="formadd" action="<?php echo site_url('admin/labparameter/add') ?>" id="employeeform"
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/labparameter/add') ?>" name="employeeform"
                ...
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label><?php echo $this->lang->line('category_name'); //$this->lang->line('name');     ?></label><small
                                class="req"> *</small>
                            <input autofocus="" id="lab_name" name="lab_name" placeholder="" type="text"
...
function get(id) {
    ...
    $.ajax({
        dataType: 'json',
        url: '<?php echo base_url(); ?>admin/labparameter/get_data/' + id,
