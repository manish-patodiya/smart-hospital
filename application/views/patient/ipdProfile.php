    ...
    ?>
                <div class="nav-tabs-custom border0 mb0" id="tabs">
                    ...
                    <ul class="nav nav-tabs navheader navlistscroll">
                        <li class="active"><a href="#overview"><i class="fa fa-th"></i>
                                <?php echo $this->lang->line('overview'); ?></a></li>
                        <li>
                            <a href="#medication" data-toggle="tab" aria-expanded="true"><i
                        ...
                        <li>
                            <a href="#operationtheatre" data-toggle="tab" aria-expanded="true"><i
                                    class="fas fa-cut"></i> <?php echo $this->lang->line('operation'); ?></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#payment" data-toggle="tab" aria-expanded="true"><i
                                    class="fas fa-hand-holding-usd"></i> <?php echo $this->lang->line('payment'); ?></a>
                        </li>
                        <?php if ($this->module_lib->hasActive('live_consultation')) {?>
                        <li>
                            <a href="#live_consult" class="" data-toggle="tab" aria-expanded="true"><i
...
$image = $result['image'];
    ...
    ?>
                                            <img width="115" height="115"
                                                ...
                                                src="<?php echo base_url(); ?><?php echo $file . img_time() ?>">
                                        </div>
                                        <!--./col-lg-5-->
                                            ...
                                            <div class="align-content-center pt25">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $this->customlib->getPatientSessionPrefixByType('ipd_no') . $result['id']; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                ...
                                                <a href="javascript:void(0)">
                                                    <img src="<?php echo base_url("uploads/staff_images/" . $result['doctor_image'] . img_time()); ?>"
                                                        class="member-profile-small media-object"></a>
                                                <?php } else {?>
                                                <img src="<?php echo base_url("uploads/staff_images/no_image.png" . img_time()) ?>"
                                                    class="member-profile-small media-object"></a>
                                                <?php }?>
                                            </div>
                                            <div class="media-body">
                                                <h5 class="media-heading"><a
                                                        href="javascript:void(0)"><?php echo $result['name'] . " " . $result['surname'] . " (" . $result['employee_id'] . ")"; ?></a>
                                                </h5>
                                            </div>
                                        </div>
                                        <!--./media-->
...
foreach ($doctors_ipd as $dkey => $dvalue) {?>
                                        <div class="media">
                                            <div class="media-left">
                                                <?php if ($dvalue['image'] != "") {?>
                                                <a href="javascript:void(0)">
                                                    <img src="<?php echo base_url("uploads/staff_images/" . $dvalue['image'] . img_time()); ?>"
                                                        class="member-profile-small media-object"></a>
                                                <?php } else {?>
                                                <img src="<?php echo base_url("uploads/staff_images/no_image.png" . img_time()) ?>"
                                                    class="member-profile-small media-object"></a>
                                            ...
                                            <div class="media-body">
                                                <h5 class="media-heading"><a
                                                        href="javascript:void(0)"><?php echo $dvalue['ipd_doctorname'] . " " . $dvalue['ipd_doctorsurname'] . " (" . $dvalue['employee_id'] . ")"; ?></a>
                                                </h5>
                                            </div>
                                        </div>
                                        <!--./media-->
                ...
                if ($timeline_list[$i]['generated_users_type'] != 'patient') {
                    ?><span class="time"></span>
                                                        ...
                                                        <span class="time"><a class="defaults-c text-right"
                                                                ...
                                                                href="<?php echo base_url() . "admin/timeline/download_patient_timeline/" . $timeline_list[$i]["id"] . "/" . $timeline_list[$i]["document"] ?>"
                                                ...
                                                <div class="col-md-12 mtop5">
                                                    <div class="topprograssstart">
                                                        <h5 class="text-uppercase mt5 bolds">
                                                            <?php echo $this->lang->line('ipd_billing_payment_graph'); ?>
                                                        </h5>
...
for ($i = 0; $i < $recent_record_count; $i++) {
        if (!empty($prescription_detail[$i])) {
            ?>
                                                    <tr>
                                                        <td><?php echo $this->customlib->getPatientSessionPrefixByType('ipd_prescription') . $prescription_detail[$i]["id"] ?>
                                                        </td>
        ...
        ?>
                                    ...
                                    <div class="box-header mb10 pl-0">
                                        <h3 class="text-uppercase bolds mt0 ptt10 pull-left font14">
                                            <?php echo $this->lang->line('consultant'); ?></h3>
                                        <div class="pull-right">
                                        </div>
                                    </div>
...
for ($i = 0; $i < $recent_record_count; $i++) {
            if (!empty($consultant_register[$i])) {
                ?>
                                                    <tr>
                                                        <td><?php echo $this->customlib->YYYYMMDDHisTodateFormat($consultant_register[$i]['date'], $this->customlib->getHospitalTimeFormat()); ?>
                                                        </td>
                                                        ...
                                                        <td><?php echo $this->customlib->YYYYMMDDTodateFormat($consultant_register[$i]['ins_date']); ?>
                                                        </td>
                                                    </tr>
                                                    <?php
}
        ...
        ?>
                                    ...
                                    <div class="box-header mb10 pl-0">
                                        <h3 class="text-uppercase bolds mt0 ptt10 pull-left font14">
                                            <?php echo $this->lang->line('investigations'); ?></h3>
                                        <div class="pull-right">
                                        </div>
                                    </div>
                                    <div class="box-header mb10 pl-0">
...
for ($i = 0; $i < $recent_record_count; $i++) {
            if (!empty($operation_theatre[$i])) {
                ...
                ?>
                                                    <tr>
                                                        <td><?php echo $this->customlib->getPatientSessionPrefixByType('operation_theater_reference_no') . $operation_theatre[$i]["id"] ?>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-transform: capitalize;">
                                                            ...
                                                            <div class="bill_item_footer text-muted">
                                                                <label><?php if ($charges[$i]["note"] != '') {echo $this->lang->line('charge_note') . ': ';}?>
...
$total_payment = 0;
        ...
        for ($i = 0; $i < $recent_record_count; $i++) {
            if (!empty($payment_details[$i])) {
                ...
                ?>
                                                    <tr>
                                                        <td><?php echo $this->customlib->getPatientSessionPrefixByType('transaction_id') . $payment_details[$i]['id']; ?>
                                                        </td>
                                                        <td><?php echo $this->customlib->YYYYMMDDHisTodateFormat($payment_details[$i]['payment_date'], $this->customlib->getHospitalTimeFormat()); ?>
                                                        </td>
                ...
                if ($payment_details[$i]['payment_mode'] == "Cheque") {
                    if ($payment_details[$i]['cheque_no'] != '') {echo $this->lang->line("cheque_no") . ": " . $payment_details[$i]['cheque_no'];
                        echo "<br>";
                    }
...
for ($i = 0; $i < $recent_record_count; $i++) {
        if (!empty($getipdoverviewtreatment[$i])) {
            ?>
                                                <tr>
                                                    <td><?php echo $this->customlib->getPatientSessionPrefixByType('ipd_no') . $getipdoverviewtreatment[$i]['ipdid']; ?>
                                                    </td>
...
for ($i = 0; $i < $recent_record_count; $i++) {
            if (!empty($bed_history[$i])) {
                ?>
                                                    <tr>
                                                        <td class="mailbox-name">
                                                            <?php echo $bed_history[$i]->bed_group; ?></td>
                                                        <td class="mailbox-name"><?php echo $bed_history[$i]->bed; ?>
                                                        </td>
                                                        <td class="mailbox-name">
                                                            <?php if ($bed_history[$i]->from_date != '') {echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($bed_history[$i]->from_date));}?>
                                                        </td>
                                                        <td class="mailbox-name">
                                                            <?php if ($bed_history[$i]->to_date != '') {echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($bed_history[$i]->to_date));}?>
                                                        </td>
                                                        <td class="mailbox-name">
                                                            <?php echo $this->lang->line($bed_history[$i]->is_active); ?>
                                                        </td>
                                                    </tr>
                                                    <?php }}?>
                                                </tbody>
...
if (!empty($consultant_register)) {
        foreach ($consultant_register as $consultant_key => $consultant_value) {
            ?>
                                        <tr>
                                            ...
                                            <td><?php echo composeStaffNameByString($consultant_value['name'], $consultant_value['surname'], $consultant_value['employee_id']); ?>
                                            </td>
    ...
    ?>
                        ...
                        <div class="tab-pane" id="labinvestigation">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover example"
                                    data-export-title="<?php echo $this->lang->line('opd_details'); ?>">
                                    <thead>
                                        <th><?php echo $this->lang->line('test_name'); ?></th>
                                        <th><?php echo $this->lang->line('lab'); ?></th>
                                        <th><?php echo $this->lang->line('sample_collected'); ?></th>
...
echo $this->customlib->YYYYMMDDTodateFormat($row['parameter_update']);
        ?>
                                            ...
                                            <td class="text-right"><a href='javascript:void(0)'
                                                    ...
                                                    data-test-id='<?php echo $row['test_name'] . " (" . $row['short_name'] . ")"; ?>'
...
echo $this->customlib->YYYYMMDDTodateFormat($value['timeline_date']); ?>
                                        ...
                                        <li>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <span class="time"><a class="defaults-c text-right"
                                                        data-toggle="tooltip" title=""
                                                        href="<?php echo base_url() . "patient/dashboard/download_patient_timeline/" . $value["id"] . "/" . $value["document"] ?>"
                                                        data-original-title="<?php echo $this->lang->line('download'); ?>"><i
                                                            class="fa fa-download"></i></a></span>
                                                <?php }?>
...
if (!empty($prescription_detail)) {
        foreach ($prescription_detail as $prescription_key => $prescription_value) {
            ?>
                                        <tr>
                                            <td><?php echo $this->customlib->getPatientSessionPrefixByType("ipd_prescription") . $prescription_value["id"] ?>
                                            </td>
                                            ...
                                            <td class="text-right">
                                                <a href="#prescription" class="btn btn-default btn-xs"
                                                    onclick="view_prescription('<?php echo $prescription_value["id"] ?>', '<?php echo $prescription_value["id"] ?>', '<?php echo "yes" ?>')"
                                                    data-toggle="tooltip"
                                                    title="<?php echo $this->lang->line('view_prescription'); ?>">
            ...
            ?>
                                        <tr>
                                            ...
                                            <td style="text-transform: capitalize;"><?php echo $charge["name"] ?>
                                                <div class="bill_item_footer text-muted"> <?php echo $charge["note"] ?>
                                                </div>
                                            </td>
                                            <td style="text-transform: capitalize;"><?php echo $charge["charge_type"] ?>
                                            </td>
                                            <td style="text-transform: capitalize;">
                                                <?php echo $charge["charge_category_name"] ?></td>
                                            <td style="text-transform: capitalize;">
                                                <?php echo $charge['qty'] . " " . $charge["unit"]; ?></td>
                                            <td class="text-right"><?php echo $charge["standard_charge"] ?></td>
                                            <td class="text-right"><?php echo number_format($charge["tpa_charge"], 2) ?>
                                            </td>

                                            <td class="text-right">
                                                <?php echo $taxamount . "(" . $charge["tax"] . "%)"; ?></td>

                                            <td class="text-right">
                                                <?php echo number_format($charge["apply_charge"], 2) ?></td>
                                    ...
                                    <tr class="box box-solid total-bg">
                                        <td colspan='10' class="text-right">
                                            <?php echo $this->lang->line('total') . ": " . $currency_symbol . '' . $total; ?><input
                                                type="hidden" id="charge_total" name="charge_total"
                        ...
                        <div class="tab-pane" id="live_consult">
                            ...
                            <div class="download_label">
                                <?php echo $result['patient_name'] . " " . $this->lang->line('opd_details'); ?></div>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover example">
                                    <thead>
                                        <th><?php echo $this->lang->line('consultation_title'); ?></th>
...
if ($conference_value->description == "") {
                ...
                ?>
                                                    <p class="text text-info">
                                                        <?php echo $conference_value->description; ?></p>
                                                    <?php
}
            ?>
                                                </div>
            ...
            ?>
                                            ...
                                            <td class="mailbox-name">
                                                <form class="chgstatus_form" method="POST"
                                                    ...
                                                    <select class="form-control chgstatus_dropdown" disabled
                                                        name="chg_status">
...
if ($conference_value->status == 0) {
                ?>
                                                <a href="<?php echo $return_response->start_url; ?>"
                                                    class="btn label-success btn-xs" target="_blank">
                                                    <i class="fa fa-sign-in"></i>
                                                    <?php echo $this->lang->line('join'); ?> </a>
                                                <?php
}
            ?>
                            ...
                            <div class="box-tab-header">
                                ...
                                <div class="box-tab-tools">
                                    ...
                                    <button type="button" class="btn btn-info btn-sm"
                                        data-result_id="<?php echo $result['ipdid'] ?>" data-toggle="modal"
                                        data-target="#payMoney"><i class="fa fa-plus"></i>
                                        <?php echo $this->lang->line('make_payment'); ?></button>
                                    <?php }?>
                                </div>
                            </div>
...
$total_payment = 0;
    if (!empty($payment_details)) {
        ...
        foreach ($payment_details as $payment) {
            ...
            ?>
                                        <tr>
                                            <td><?php echo $this->customlib->getPatientSessionPrefixByType('transaction_id') . $payment["id"] ?>
                                            </td>
                                    ...
                                    <tr class="box box-solid total-bg">
                                        <td class="text-right" colspan="4"><?php echo $this->lang->line('total'); ?> :
                                        </td>

                                        <td class="text-right">
                                            <?php echo $currency_symbol . number_format($total_payment, 2); ?>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <?php }?>
...
if (!empty($max_dose)) {
    ...
    for ($x = 1; $x <= $dosage_count; $x++) {?>
                                        ...
                                        <th class="sticky-col" width="150">
                                            <?php echo $this->lang->line("dose") . '' . $x; ?></th>
                                        <?php }
    ?>
                                    </thead>
                                    <tbody>
...
if (!empty($operation_theatre)) {
        foreach ($operation_theatre as $ot_key => $ot_value) {
            ?>
                                        <tr>
                                            <td><?php echo $this->customlib->getPatientSessionPrefixByType('operation_theater_reference_no') . $ot_value["id"] ?>
                                            </td>
                                            <td><?php echo $this->customlib->YYYYMMDDHISTodateformat($ot_value["date"]) ?>
                                            </td>
        ...
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title">
                    <?php echo $this->lang->line('discharged') . " " . $this->lang->line('summary'); ?></h4>
            </div>
            <div class="modal-body pt0 pb0">
        ...
        <div class="modal-content">
            ...
            <form id="payment_form" class="form-horizontal " method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="amount"
                            class="col-sm-3 control-label"><?php echo $this->lang->line('payment_amount'); ?>
                            (<?php echo $currency_symbol; ?>)</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" value="<?=$total - $total_payment;?>"
                                name="deposit_amount" id="amount_total_paid">
                            <input type="hidden" class="form-control" value="<?=$total - $total_payment;?>"
                ...
                <div class="modal-footer">
                    <button type="submit" id="pay_button"
                        class="btn btn-info pull-right make_payment"><?php echo $this->lang->line('add') ?></button>
                </div>
            </form>
        </div>
...
function getRecordsummary(id, ipdid) {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#edit_deletebill').html("<a href='#' data-toggle='tooltip' onclick='printData(" + id + "," +
                ipdid +
                ")'   data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a> "
                );
...
function view_prescription(id, ipdid) {
    ...
    $('#edit_deleteprescription').html(
        "<a href='#prescription'' data-toggle='tooltip' data-original-title='Print'onclick='printprescription(" +
        id + "," + ipdid +
        ")'   data-original-title='<?php echo $this->lang->line('print'); ?>' ><i class='fa fa-print'></i></a>");
