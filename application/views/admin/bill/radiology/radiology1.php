            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"> <?php echo $this->lang->line('radiology_single_billing'); ?>
                        </h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-primary btn-sm assigntest" id="load1"
                                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i
                                    class="fa fa-plus"></i> <?php echo $this->lang->line('add_patient'); ?></button>
...
function getPrescriptionData() {
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>admin/labtest/prescriptionBill',
        type: "POST",
        data: {
        ...
        success: function(res) {
            ...
            $('#case_reference_id').val(res.case_reference_id);
            $('.test_name').select2();
            var option = new Option(res.patient_name + " (" + res.patient_id + ")", res.patient_id, true,
                true);
