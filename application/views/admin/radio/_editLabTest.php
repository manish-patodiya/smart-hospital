...
<div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" name="test_name" class="form-control"
                        value="<?php echo set_value('test_name', $result->test_name); ?>">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" name="short_name" class="form-control"
                        value="<?php echo set_value('short_name', $result->short_name); ?>">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" name="test_type" class="form-control"
                        value="<?php echo set_value('test_type', $result->test_type); ?>">
    ...
    ?>
                            <option value="<?php echo $dvalue["id"]; ?>"
                                <?php echo set_select('radiology_category_id', $dvalue["id"], ($result->radiology_category_id == $dvalue["id"]) ? true : false); ?>>
                                <?php echo $dvalue["lab_name"] ?></option>
                            <?php }?>
                        </select>
                    </div>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" name="sub_category" class="form-control"
                        value="<?php echo set_value('sub_category', $result->sub_category); ?>">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <label><?php echo $this->lang->line('report_days'); ?></label>
                    <input type="number" min="0" name="report_days" class="form-control"
                        value="<?php echo set_value('report_days', $result->report_days); ?>">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <small class="req">*</small>
                    <div>
                        <select class="form-control charge_category select2" name='charge_category_id'
                            style="width: 100%;">
    ...
    ?>
                            <option value="<?php echo $charge_cat_value["id"]; ?>"
                                <?php echo set_select('charge_category_id', $charge_cat_value["id"], ($result->charge_category_id == $charge_cat_value["id"]) ? true : false); ?>>
                                <?php echo $charge_cat_value["name"]; ?></option>
                            <?php }?>
                        </select>
                    </div>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    <label for="exampleInputFile"><?php echo $this->lang->line('tax'); ?> (%)<small class="req">
                            *</small></label>
                    <div>
                        <input class="form-control" name='tax' id="tax"
                            value="<?php echo set_value('tax', $result->percentage); ?>" readonly="true">
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <label
                        for="exampleInputFile"><?php echo $this->lang->line('standard_charge'); ?></label><?php echo ' (' . $currency_symbol . ')'; ?>
                    <small class="req">*</small>
                    <div>
                        <input class="form-control" name='standard_charge' id="standard_charge"
                            value="<?php echo set_value('standard_charge', $result->standard_charge); ?>"
                            readonly="true">
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <label
                        for="exampleInputFile"><?php echo $this->lang->line('amount') . ' (' . $currency_symbol . ')'; ?></label>
                    <small class="req">*</small>
                    <div>
                        <input readonly
                            value="<?php echo set_value('standard_charge', amountFormat($result->standard_charge + calculatePercent($result->standard_charge, $result->percentage))); ?>"
                            class="form-control" name='amount' id="amount">
                    </div>
                    <span class="text-danger"><?php echo form_error('amount'); ?></span>
                </div>
            </div>
            <?php echo display_custom_fields('labtest', $result->id); ?>
        </div>
        <!--./row-->
    </div>
    <!--./col-md-12-->
...
if (!empty($result->lab_parameter)) {
    $total_rows = 1;
    foreach ($result->lab_parameter as $param_key => $param_value) {
        ?>
                ...
                <tr id="row<?php echo $total_rows; ?>">
                    <td width="35%">
                        ...
                        <input type="hidden" name="inserted_id_<?php echo $total_rows; ?>"
                            value="<?php echo $param_value->id; ?>">
                        <input type="hidden" class="post_parameter_id" name="post_parameter_id"
                            value="<?php echo $param_value->radiology_parameter_id; ?>">
                        <select class="form-control select2 radiology_parmeter" style="width:100%"
                            id="parameter_name_<?php echo $total_rows; ?>"
                            name='parameter_name_<?php echo $total_rows; ?>'>
                            <option value="<?php echo set_value('radiology_parameter_id'); ?>">
                                <?php echo $this->lang->line('select') ?></option>
                            <?php foreach ($parametername as $dkey => $dvalue) {?>
                            <option value="<?php echo $dvalue["id"]; ?>"
                                <?php echo set_select('parameter_name_' . $total_rows, $dvalue["id"], ($param_value->radiology_parameter_id == $dvalue["id"]) ? true : false); ?>>
                                <?php echo $dvalue["parameter_name"] ?></option>
                            <?php }?>
                        </select>
                    </td>
                    <td width="30%">
                        <input type="text" readonly="" name="reference_range_<?php echo $total_rows; ?>"
                            id="reference_range_<?php echo $total_rows; ?>" class="form-control reference_range">
                    </td>
                    <td width="30%">
                        <input type="text" readonly="" name="radio_unit_<?php echo $total_rows; ?>" id="radio_unit_"
                            class="form-control radio_unit">
                    </td>
                    <td>
...
?>
        ...
        <a class="btn btn-info addplus-xs btn-sm add-record mb10" data-added="0"><i class="fa fa-plus"></i>
