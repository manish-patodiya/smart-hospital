        ...
        ?> /></td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a class="btn btn-default btn-xs editcharge"
                                                data-record-id='<?php echo $chargetype['id'] ?>' data-toggle="tooltip"
...
if ($chargetype['is_default'] != 'yes') {
        if ($this->rbac->hasPrivilege('charge_type', 'can_delete')) {?>
                                            <a class="btn btn-default btn-xs" data-toggle="tooltip"
                                                ...
                                                onclick="deleteChargeType('<?php echo $chargetype['id'] ?>')" ;>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" class="ptt10" action="<?php echo site_url('admin/chargetype/add') ?>" id="employeeform"
...
<div class="modal fade" id="editchargeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editform" action="<?php echo site_url('admin/chargetype/edit') ?>" name="employeeform"
                method="post" accept-charset="utf-8" enctype="multipart/form-data" class="ptt10">
                <div class="modal-body pt0 pb0">
                    <div class="form-group">
                        <label><?php echo $this->lang->line('name'); ?></label><small class="req"> *</small>
