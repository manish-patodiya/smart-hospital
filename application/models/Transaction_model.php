...
//new function
    ...
    public function ipd_bill_paymentbycase_id($case_id)
    {
        ...
        $ipd_bill_payment['lab']['bill'] = $this->db->select('sum(net_amount) as total_bill')->from('lab_billing')->where('lab_billing.case_reference_id', $case_id)->get()->row_array();
        $ipd_bill_payment['lab']['payment'] = $this->db->select('sum(amount) as total_payment')->from('transactions')->where(array('case_reference_id' => $case_id, 'lab_billing_id !=' => 'NULL'))->get()->row_array();
        ...
        $ipd_bill_payment['lab']['lab_bill_payment_ratio'] = cal_percentage($ipd_bill_payment['lab']['payment']['total_payment'], $ipd_bill_payment['lab']['bill']['total_bill']);
