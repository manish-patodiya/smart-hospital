...
class Labparameter extends Admin_Controller
{
    ...
    public function addlab()
    {
        ...
        $labName = $this->lab_model1->getlabName();
        $data["labName"] = $labName;
        $this->form_validation->set_rules(
            'lab_name', $this->lang->line('category_name'), array('required',
                array('check_exists', array($this->lab_model1, 'valid_parameter_name')),
            )
        );
        ...
        if ($this->form_validation->run()) {
            ...
            $insert_id = $this->lab_model1->addLabName($data);
            ...
            $this->load->view("admin/lab_test/labcategory", $data);
            $this->load->view("layout/footer");
        }
    }
    public function unit()
    {
        if (!$this->rbac->hasPrivilege('lab_unit', 'can_view')) {
            access_denied();
        }
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'addlab/index');
        $unit_id = $this->input->post("unit_id");
        $unitname = $this->lab_model1->getunit();
        $data["unitname"] = $unitname;
        $this->form_validation->set_rules(
            'unit_name', $this->lang->line('unit_name'), array('required',
                array('check_exists', array($this->lab_model1, 'valid_unit_name')),
            )
        );
        ...
        if ($this->form_validation->run()) {
            ...
            $insert_id = $this->lab_model1->addunit($data);
            $this->session->set_flashdata('msg', '<div class="alert alert-success">' . $this->lang->line('record_added_successfully') . '</div>');
            redirect("admin/pathologycategory/addCategory");
        } else {
            $this->load->view("layout/header");
            $this->load->view("admin/lab_test/unit", $data);
            $this->load->view("layout/footer");
        }
    }
    ...
    public function get_dataunit($id)
    {
        ...
        $result = $this->lab_model1->getunit($id);
    ...
    public function deleteunit($id)
    {
        ...
        $this->lab_model1->deleteunit($id);
        redirect('admin/labparameter/unit');
    }
    ...
    {
        if (!$this->rbac->hasPrivilege('lab_parameter', 'can_view')) {
            access_denied();
        }
        $this->session->set_userdata('top_menu', 'setup');
        $this->session->set_userdata('sub_menu', 'addlab/index');
        ...
        $this->form_validation->set_rules(
            'parameter_name', $this->lang->line('parameter_name'), array('required',
                array('check_exists', array($this->lab_model1, 'valid_lab_name')),
            )
        );
        $data["title"] = "Add Lab";
        if ($this->form_validation->run()) {
            ...
            $insert_id = $this->lab_model1->addLabName($data);
            $this->session->set_flashdata('msg', '<div class="alert alert-success">' . $this->lang->line('record_added_successfully') . '</div>');
            redirect("admin/lab/labparameter");
        } else {
            $this->load->view("layout/header");
            $this->load->view("admin/lab_test/labparameter", $data);
            $this->load->view("layout/footer");
        }
    }
    ...
    public function addparameter()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $insert_id = $this->lab_model1->addparameter($data);
        }
        echo json_encode($array);
    }
    ...
    public function get()
    {
        ...
        echo $this->lab_model1->getall();
    }

    public function edit($id)
    {
        $result = $this->lab_model1->getLabName($id);
        $data["result"] = $result;
    ...
    public function delete($id)
    {
        ...
        $this->lab_model1->delete($id);
        redirect('admin/labparameter/addlab');
    }
    ...
    public function delete_parameter($id)
    {
        ...
        $this->lab_model1->delete_parameter($id);
        redirect('admin/labparameter/lab_parameter');
    }
