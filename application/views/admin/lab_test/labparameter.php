        ...
        <div class="row">
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        <?php if ($this->rbac->hasPrivilege('lab_category', 'can_view')) {?>
                        <li><a
                                href="<?php echo base_url(); ?>admin/labparameter/addlab"><?php echo $this->lang->line('lab_category'); ?></a>
                        </li>
                        <?php }if ($this->rbac->hasPrivilege('lab_unit', 'can_view')) {?>
                        <li><a href="<?php echo base_url(); ?>admin/labparameter/unit"
                                class=""><?php echo $this->lang->line('unit'); ?></a></li>
                        <?php }if ($this->rbac->hasPrivilege('lab_parameter', 'can_view')) {?>
                        <li><a class="active" href="<?php echo base_url(); ?>admin/labparameter/labparameter"
                                class=""><?php echo $this->lang->line('lab_parameter'); ?></a></li>
                        <?php }?>
                    </ul>
                </div>
            </div>
            <div class="col-md-10">
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('lab_parameter_list'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('lab_parameter', 'can_add')) {?>
                            <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm radiology"><i
                                    class="fa fa-plus"></i>
                                <?php echo $this->lang->line('add_lab_parameter'); ?></a>
                            <?php }?>
                        </div>
                    </div>
                    <div class="box-body">
...
foreach ($parameterName as $parameter) {
    ?>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <?php if ($this->rbac->hasPrivilege('lab_parameter', 'can_edit')) {?><a
                                            ...
                                            <?php }?>
                                            <?php if ($this->rbac->hasPrivilege('lab_parameter', 'can_delete')) {?>
                                            <a href="<?php echo base_url(); ?>admin/labparameter/delete_parameter/<?php echo $parameter['id'] ?>"
                                                class="btn btn-default btn-xs" data-toggle="tooltip"
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('add_lab_parameter'); ?></h4>
            </div>

            <form id="formadd" action="<?php echo site_url('admin/labparameter/addparameter') ?>" id="employeeform"
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <label><?php echo $this->lang->line('reference_range'); ?></label><small class="req">
                                *</small>
                            <input autofocus="" name="reference_range" placeholder="" type="text"
                                class="form-control" />
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('edit_lab_parameter'); ?></h4>
            </div>

            <form id="editformadd" action="<?php echo site_url('admin/labparameter/addparameter') ?>"
                    ...
                    <div class="">
                        ...
                        <div class="form-group">
                            <label><?php echo $this->lang->line('reference_range'); //$this->lang->line('name');     ?></label><small
                                class="req"> *</small>
                            <input autofocus="" id="edit_reference_range" name="reference_range" placeholder=""
                                type="text" class="form-control" value="" />
                            <span class="text-danger"><?php echo form_error('reference_range'); ?></span>
                        </div>
                        <div class="form-group">
...
function get(id) {
    ...
    $.ajax({
        dataType: 'json',
        url: '<?php echo base_url(); ?>admin/labparameter/get_parameterdata/' + id,
