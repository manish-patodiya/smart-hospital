                        ...
                        <div class="box-tools pull-right">
                            ...
                            <button class="btn btn-primary btn-sm radiology addtest"
                                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i
                                    class="fa fa-plus"></i>
                                <?php echo $this->lang->line('add_radiology_test'); ?></button>
                            <?php }?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover ajaxlist" cellspacing="0"
                                width="100%" data-export-title="<?php echo $this->lang->line('radiology_test'); ?>">
                                <thead>
...
function viewDetail(id) {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#edit_delete').html(
                "<?php if ($this->rbac->hasPrivilege('radiology_test', 'can_edit')) {?><a href='#' class='edittest' data-record-id='" +
                id +
                "'  data-loading-text='<i class= \"fa fa-circle-o-notch fa-spin\"></i>' data-toggle='tooltip'   data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php }if ($this->rbac->hasPrivilege('radiology_test', 'can_delete')) {?><a onclick='delete_record(" +
                id +
...
(function($) {
    'use strict';
    $(document).ready(function() {
        initDatatable('ajaxlist', 'admin/labtest/getradiologytestDatatable', [], [], 100,
            [{
                "sWidth": "100px",
                "bSortable": false,
                "aTargets": [-1, -2, -3],
