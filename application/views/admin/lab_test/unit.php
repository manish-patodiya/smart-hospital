            ...
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <li><a class="active" href="<?php echo base_url(); ?>admin/labparameter/unit"
                                class=""><?php echo $this->lang->line('unit'); ?></a></li>
                        <?php } if ($this->rbac->hasPrivilege('lab_parameter', 'can_view')) { ?>
                        <li><a href="<?php echo base_url(); ?>admin/labparameter/lab_parameter"
                ...
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools addmeeting">
                            ...
                            <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm unit"><i
                                    class="fa fa-plus"></i> <?php echo $this->lang->line('add_unit'); ?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="box-body">
                                        ...
                                        <td class="text-right">
                                            ...
                                            <?php
                                                ...
                                                if ($this->rbac->hasPrivilege('radiology_unit', 'can_delete')) {
                                                    ?>
                                            <a href="<?php echo base_url(); ?>admin/labparameter/deleteunit/<?php echo $lab['id'] ?>"
                                                class="btn btn-default btn-xs" data-toggle="tooltip"
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" action="<?php echo site_url('admin/lab/addunit') ?>" id="employeeform"
                name="employeeform" method="post" accept-charset="utf-8">
                <div class="modal-body pb0">
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo $this->lang->line('unit_name'); ?></label><small
                            class="req"> *</small>
                ...
                <div class="modal-footer">
                    <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>"
                        id="formaddbtn" class="btn btn-info pull-right"><i class="fa fa-check-circle"></i>
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/lab/addunit') ?>" name="employeeform"
                method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="modal-body pb0">
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo $this->lang->line('unit_name'); ?></label><small
                            class="req"> *</small>
                        <input autofocus="" id="unit_name" name="unit_name" placeholder="" type="text"
