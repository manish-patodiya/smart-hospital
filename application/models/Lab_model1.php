...
class Lab_model1 extends MY_model
{
    ...
    public function addparameter($data)
    {
        ...
        if (isset($data['id'])) {
            ...
            $this->db->update('lab_parameter', $data);
            ...
            $this->db->insert('lab_parameter', $data);
    ...
    public function check_parameter_exists($name, $id)
    {
        if ($id != 0) {
            ...
            $query = $this->db->where($data)->get('lab_parameter');
            if ($query->num_rows() > 0) {
                return true;
            } else {
                return false;
            ...
            $query = $this->db->get('lab_parameter');
            if ($query->num_rows() > 0) {
                return true;
            } else {
                return false;
    ...
    public function delete_parameter($id)
    {
        ...
        $this->db->trans_strict(false); # See Note 01. If you wish can remove as well
        //=======================Code Start===========================
        $this->db->where("id", $id)->delete("lab_parameter");
