                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form id="formsearch" accept-charset="utf-8" method="post" class="form-inline align-top">
                            ...
                            <div class="form-group">
                                <div class="">
                                    <label><?php echo $this->lang->line('case_id'); ?></label><small class="req">
                                        *</small>
                    ...
                    <div class="nav-tabs-custom border0">
                        <ul class="nav nav-tabs navlistscroll">
                            ...
                            <li class="active"><a href="#opd" data-toggle="tab" aria-expanded="true"
                                    onclick="load_opd_data()"><?php echo $this->lang->line('opd') ?></a></li>
                            <?php }if ($this->rbac->hasPrivilege('ipd_billing', 'can_view')) {?>
                            <li><a onclick="load_ipd_data()" href="#ipd" data-toggle="tab"
                                    aria-expanded="true"><?php echo $this->lang->line('ipd') ?></a></li>
                            <?php }if ($this->rbac->hasPrivilege('pharmacy_billing', 'can_view')) {?>
                            <li><a href="#pharmacy" onclick="load_pharmacy_data()" data-toggle="tab"
                                    aria-expanded="true"><?php echo $this->lang->line('pharmacy') ?></a></li>
                            <?php }if ($this->rbac->hasPrivilege('pathology_billing', 'can_view')) {?>
                            <li><a href="#pathology" onclick="load_pathology_data()" data-toggle="tab"
                                    aria-expanded="true"><?php echo $this->lang->line('pathology') ?></a></li>
                            <?php }if ($this->rbac->hasPrivilege('radiology_billing', 'can_view')) {?>
                            <li><a href="#radiology" onclick="load_radiology_data()" data-toggle="tab"
                                    aria-expanded="true"><?php echo $this->lang->line('radiology') ?></a></li>
                            <?php }if ($this->rbac->hasPrivilege('blood_bank_billing', 'can_view')) {?>
                            <li><a href="#blood_bank" onclick="load_blood_bank_data()" data-toggle="tab"
                                    aria-expanded="true"><?php echo $this->lang->line('blood_bank') ?></a></li>
                            <?php }if ($this->rbac->hasPrivilege('ambulance_billing', 'can_view')) {?>
                            <li><a href="#ambulance" onclick="load_ambulance_data()" data-toggle="tab"
                                    aria-expanded="true"><?php echo $this->lang->line('ambulance') ?></a></li>
                            <?php }?>
                        </ul>
    ...
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"><span id="patient_bill_summary"> </span> <?=$this->lang->line("bill_summary");?>
                </h4>
            </div>
...
$(document).on('click', '.payment_refund', function() {
    if (get_case_id() !== 0) {
        ...
        payment_modal.modal('show');
        $.ajax({
            url: base_url + 'admin/bill1/getrefund/' + get_case_id(),
            type: "POST",
...
$(document).on('click', '.patient_discharge', function() {
    if (get_case_id() !== 0) {
        ...
        payment_modal.modal('show');
        $.ajax({
            url: base_url + 'admin/bill1/patient_discharge/' + get_case_id(),
            type: "POST",
            data: {
                'module_type': 'bill'
            },
...
function getbloodbankPayments(record_id, patient_id = null) {
    ...
    $.ajax({
        url: '<?php echo base_url() ?>admin/bill1/getBloodbankTransaction',
        type: "POST",
        data: {
            'id': record_id,
...
$(document).on('click', '.view_payment', function(e) {
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>admin/bill1/getpayment',
        type: "POST",
        data: {
            'case_id': caseid,
            'id': record_id,
        ...
        success: function(res) {
            $('#allpayments_print').html(
                ...
                record_id + '" data-toggle="tooltip" title="" data-module_type="' +
                module_type + '" data-case_id="' + caseid +
...
$(document).ready(function(e) {
    $("#add_payment").on('submit', (function(e) {
        ...
        $.ajax({
            url: base_url + 'admin/bill1/makepayment',
            type: "POST",
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
...
$(document).ready(function(e) {
    ...
    $("#formsearch").on('submit', (function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url(); ?>admin/bill1/get',
            type: "POST",
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
...
function get_patientdetails(case_id) {
    $.ajax({
        url: base_url + 'admin/bill1/getDetailsByCaseId/' + case_id,
        type: "POST",
        dataType: 'json',
        contentType: false,
        cache: false,
...
function load_opd_data() {
    if (get_case_id() !== 0) {
        ...
        $.ajax({
            url: base_url + 'admin/bill1/getopd/' + get_case_id(),
            type: "POST",
...
function load_ipd_data() {
    ...
    if (get_case_id() !== 0) {
        $.ajax({
            url: base_url + 'admin/bill1/getipd/' + get_case_id(),
            type: "POST",
    ...
    if (get_case_id() !== 0) {
        (function($) {
            ...
            $(document).ready(function() {
                initDatatable('load_pharmacy', 'admin/bill1/getpharmacy/' + get_case_id(), [], [], 100,
                    [{
                            "sWidth": "105px",
                            "aTargets": [-1, -2, -3, -4],
...
function load_pathology_data() {
    if (get_case_id() !== 0) {
        (function($) {
            'use strict';
            $(document).ready(function() {
                initDatatable('load_pathology', 'admin/bill1/getpathology/' + get_case_id(), [], [], 100,
                    [{
                            "sWidth": "105px",
                            "aTargets": [-1, -2, -3, -4],
                            'sClass': 'dt-body-right dt-head-right'
...
function load_radiology_data() {
    if (get_case_id() !== 0) {
        (function($) {
            'use strict';
            $(document).ready(function() {
                initDatatable('load_radiology', 'admin/bill1/getradiology/' + get_case_id(), [], [], 100,
                    [{
                            "sWidth": "105px",
                            "aTargets": [-1, -2, -3, -4],
                            'sClass': 'dt-body-right dt-head-right'
...
function load_blood_bank_data() {
    if (get_case_id() !== 0) {
        (function($) {
            'use strict';
            $(document).ready(function() {
                initDatatable('load_blood_bank', 'admin/bill1/getbloodbank/' + get_case_id(), [], [], 100,
                    [{
                        "sWidth": "150px",
                        "bSortable": false,
                        "aTargets": [-1, -2, -3],
...
$(document).on('click', '.print_charge', function() {
    ...
    $this.button('loading');
    $.ajax({
        url: '<?php echo base_url(); ?>admin/bill1/printCharge',
        type: "POST",
        data: {
            'id': record_id,
            'type': moduletype
...
$(document).on('click', '.print_transactions', function() {
    ...
    $this.button('loading');
    $.ajax({
        url: '<?php echo base_url(); ?>admin/bill1/printTransaction',
        type: "POST",
        data: {
            'id': record_id,
...
$(document).on('click', '.view_generate_bill', function() {
    ...
    $this.button('loading');
    $.ajax({
        url: '<?php echo base_url(); ?>admin/bill1/generate_bill_result',
        type: "POST",
        data: {
            'id': record_id,
            'module_type': moduletype,
...
$(document).on('click', '.generate_bill', function() {
    ...
    $this.button('loading');
    $.ajax({
        url: '<?php echo base_url(); ?>admin/bill1/generate_bill',
        type: "POST",
        data: {
            'id': record_id,
            'module_type': moduletype,
...
$(document).on('click', '.print_bill', function() {
    ...
    var $this = $(this);
    $.ajax({
        url: base_url + 'admin/bill1/print_patient_bill',
        type: "POST",
        data: {
            'case_id': case_id
        },
...
$(document).on('click', '.print_radio_bill', function() {
    ...
    var record_id = $(this).data('recordId');
    $.ajax({
        url: '<?php echo base_url() ?>admin/labtest/getBillDetails/',
        type: "POST",
        data: {
            'id': record_id,
            'print': true
...
function getambulancePayments(record_id) {
    var payment_modal = $('#addPaymentModal');
    $.ajax({
        url: '<?php echo base_url() ?>admin/bill1/getAmbulanceCallTransaction',
        type: "POST",
        data: {
            'id': record_id
        },
...
function load_ambulance_data() {
    if (get_case_id() !== 0) {
        (function($) {
            'use strict';
            $(document).ready(function() {
                initDatatable('load_ambulance', 'admin/bill1/getambulance/' + get_case_id(), [], [], 100,
                    [{
                        "sWidth": "150px",
                        "bSortable": false,
                        "aTargets": [-1, -2, -3],
...
$(document).on('click', '.print_dischargecard', function() {
    ...
    $this.button('loading');
    $.ajax({
        url: '<?php echo base_url(); ?>admin/bill1/print_dischargecard',
        type: "POST",
        data: {
            'id': record_id,
            'case_id': case_id,
...
$(document).on('click', '.showbill', function() {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'admin/bill1/patient_bill',
        data: {
...
$(document).on('click', '.print_ambulance_receipt', function() {
    ...
    $this.button('loading');
    $.ajax({
        url: '<?php echo base_url(); ?>admin/bill1/print_ambulance_Transaction',
        type: "POST",
        data: {
            'id': record_id
        },
    ...
    $("#case_id").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.ajax({
                ...
                url: base_url + 'admin/bill1/getcaseid',
