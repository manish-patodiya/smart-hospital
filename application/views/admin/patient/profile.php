                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                ...
                                                <a
                                                    ...
                                                    <img src="<?php echo base_url() . "uploads/staff_images/" . $doc_value['image'] . img_time(); ?>"
                                            ...
                                            <div class="media-body">
                                                ...
                                                <h5 class="media-heading"><a
                                                        href="<?php echo base_url() . 'admin/staff/profile/' . $doc_value['id']; ?>"><?php echo $doc_value["name"] . " " . $doc_value["surname"] . "  (" . $doc_value["employee_id"] . ")" ?></a>
    ...
    foreach ($patientdetails['patient']['visitdetails'] as $value) {
        ...
        if ($i <= $recent_record_count) {
            ...
            ?>
                                                            <tr>
                                                                <td><a
                                                                        href="<?php echo base_url() . 'admin/patient/visitdetails/' . $id . '/' . $value['opd_id']; ?>"><?php echo $opd_id; ?></a>
                                                                </td>
                                                                <td><?php echo $value['case_reference_id']; ?></td>
                                                                <td><?php echo $this->customlib->YYYYMMDDHisTodateFormat($value['appointment_date'], $timeformat); ?>
                                                                </td>
                                                                <td><?php echo composeStaffNameByString($value['name'], $value['surname'], $value['employee_id']); ?>
                                                                </td>
