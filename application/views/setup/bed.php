    ...
    foreach ($bed_list as $key => $value) {
        ?>
                                    <tr>
                                        ...
                                        <td><?php echo ($value['is_active'] == "unused") ? "" : "<i class='fa fa-check-square-o'></i>" ?>
                                        </td>
                                        <td class="mailbox-date pull-right">
                                            ...
                                            <a class="btn btn-default btn-xs" data-toggle="tooltip" title=""
                                                onclick="delete_recordByIdReload('admin/setup/bed/delete/<?php echo $value['id']; ?>', '')"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="mark_as_unused">
                                    <?php echo $this->lang->line('mark_as_unused'); ?> </label>
                ...
                <div class="modal-body pt0 pb0">
                    <div class="row" id="edit_bedtypedata">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="checkbox-inline">
                                    <input id="mark_as_unused" type="checkbox" name="mark_as_unused">
                                    <?php echo $this->lang->line('mark_as_unused'); ?> </label>
                            </div>
                        </div>
                    </div>
