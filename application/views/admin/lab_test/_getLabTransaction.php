...
<div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <table class="table table-hover table-sm">
                    <tr>
                        ...
                        <td><?php echo $this->customlib->getSessionPrefixByType('radiology_billing') . $radio_billing->id ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo composeStaffNameByString($radio_billing->name, $radio_billing->surname, $radio_billing->employee_id); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><label><?php echo $this->lang->line('age'); ?></label></td>
                        <td><?php echo $this->customlib->getPatientAge($radio_billing->age, $radio_billing->month, $radio_billing->day); ?>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="table table-hover table-sm">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <?php echo "(" . $radio_billing->discount_percentage . "%) " . $currency_symbol . $radio_billing->discount; ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <?php echo $currency_symbol . amountFormat($radio_billing->net_amount - $radio_billing->total_deposit); ?>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div class="col-lg-5 col-md-5 col-sm-5">
        <form id="<?php echo $form_id; ?>" action="<?php echo site_url('admin/radio/partialbill') ?>"
            accept-charset="utf-8" method="post" class="ptt10">
            <input type="hidden" name="radiology_billing_id" value="<?php echo $lab_billing_id; ?>">
...
if ($is_bill) {
            ?>
                    <a href='javascript:void(0)' data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
                        ...
                        class='btn btn-default btn-xs print_radio_receipt' data-toggle='tooltip'
...
//         if (!$(this).val())
//             $(this).data("DateTimePicker").date(moment(new Date).format(datetime_format));
//     })
// })
</script>