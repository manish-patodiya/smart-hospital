                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <img class="profile-user-img img-responsive img-circle"
                            src="<?php echo base_url() . $file.img_time() ?>" alt="User profile picture">
                        <h3 class="profile-username text-center"><?php echo $result['patient_name']; ?></h3>
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('patient_id'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $result['id']; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('gender'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $result['gender']; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('marital_status'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $result['marital_status']; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('phone'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $result['mobileno']; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('email'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $result['email']; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('address'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $result['address']; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('guardian_name'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $result['guardian_name']; ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>
                                            <?php echo $this->lang->line('appointment_date'); ?></label><small
                                            class="req"> *</small>
                                        <input type="text" name="appointment_date" class="form-control datetime"
                                            id="appointmentdate" />
                                        <input type="hidden" class="form-control" name="visitid" id="visitid" />
                                        <input type="hidden" name="patient_id" class="form-control datetime"
                                            id="patientid" />
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="edit_temperature" name="temperature"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select name="organisation" style="width:100%" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select onchange="" name="consultant_doctor" style="width: 100%" <?php
                                            ...
                                            <option value="<?php echo $dvvalue["id"] ?>">
                                                <?php echo $dvvalue["name"] . " " . $dvvalue["surname"]."  (".$dvvalue["employee_id"].")" ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="edit_revisit_note"
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        ...
                                        <div class="row ptt10" id="patientDetails">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-3">
                                                <div class="pull-right">
                                                    <img class="profile-user-img img-responsive" id="patient_image"
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#edit_delete').html(
                ...
                visitid +
                ")' data-target='#editModal' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php } ?><?php if ($this->rbac->hasPrivilege('revisit', 'can_delete')) { ?><a href='#' data-toggle='tooltip'  onclick='delete_record(" +
                opdid +
...
$(document).on('click', '.add-record', function() {
    ...
    var div = "<input type='hidden' name='rows[]' value='" + prescription_rows +
        "' autocomplete='off'><div id=row1><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div class='form-group'><label><?php echo $this->lang->line("medicine_category"); ?></label><small class='req'> *</small><select class='form-control select2 medicine_category'  name='medicine_cat_" +
        ...
        prescription_rows +
        "''> </small></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div class=form-group><label><?php echo $this->lang->line("dose"); ?></label><small class='req'> *</small><select  class='form-control select2 medicine_dosage' name='dosage_" +
        prescription_rows + "' id='search-dosage" + prescription_rows +
        "'><option value='l'><?php echo $this->lang->line('select'); ?></option></select></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div class=form-group><label><?php echo $this->lang->line("dose_interval"); ?></label><select  class='form-control select2 interval_dosage' name='interval_dosage_" +
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == "fail") {
                    ...
                    successMsg(data.message);
                    $.ajax({
                        url: base_url + 'admin/timeline/patient_timeline/' +
                            patient_id,
                        success: function(res) {
        ...
        success: function(data) {
            ...
            if (data.image != '') {
                ...
                $("#patient_image").attr("src",
                    "<?php echo base_url(); ?>uploads/patient_images/no_image.png");
            }
            ...
            success: function(data) {
                ...
                if (data.status == "fail") {
                    ...
                    window.location.assign(
                        "<?php echo base_url(); ?>admin/patient/ipdprofile/" + move_id);
                }
                btn.button('reset');
