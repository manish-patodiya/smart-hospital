        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="mb10">
                            <a class='btn <?php echo $this->input->get('doc_id') ? 'btn-info' : 'btn-success' ?> btn-border doc'
                                href="<?php echo base_url(); ?>admin/patient/search">
                                All</a>
                            <?php foreach ($doctors as $dkey => $value) {?>
                            <!-- <div class='btn btn-info btn-border  doc'> -->

                            <a href="<?php echo base_url(); ?>admin/patient/search?doc_id=<?php echo $value['id'] ?>"
                                class=' btn <?php echo $this->input->get('doc_id') != $value['id'] ? 'btn-info' : 'btn-success' ?> btn-border doc'>
                                <?php echo $value["name"] . " " . $value["surname"] ?></a>
                            <!-- </div> -->
                            <?php }?>
                        </div>
                        <input type="text" class="from-date" id="from_date" />
                        <input type="text" class="from-date" id="to_date" />
                        <span class="btn btn-search" id='serachbydate'><i class="fa fa-search"></i></span>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="paid_amount" id="paid_amount"
                                                    class="form-control">
                                                <span
                                                    class="text-danger"><?php echo form_error('paid_amount'); ?></span>
                                            </div>
                                        </div>
...
(function($) {
    ...
    function datatable() {
        initDatatable('ajaxlist',
            'admin/patient/getopddatatable<?php echo $this->input->get("doc_id") ? "?doc_id=" . $this->input->get("doc_id") : "" ?>', {
