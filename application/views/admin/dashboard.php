        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="alert alert-danger">
                    Smart Hospital may not work properly because ONLY_FULL_GROUP_BY is enabled, consult with your
                    hosting provider to disable ONLY_FULL_GROUP_BY in sql_mode configuration.
                </div>
                <?php }
$show = false;
    ...
    ?>
                <div class="dashalert alert alert-success alert-dismissible" role="alert">
                    <button type="button" class="alertclose close close_notice" data-dismiss="alert" aria-label="Close"
                        data-noticeid="<?php echo $notice_value->id; ?>"><span
...
?>
            <?php
// if ($this->module_lib->hasActive('ipd')) {
if ($this->rbac->hasPrivilege('cash_income', 'can_view')) {
    ?>
            <div class="col-lg-2 col-md-3 col-sm-6 col20"
                title="<?php echo "Cash Income"; //$this->lang->line('today_cash_income');                                      ?>">
                <div class="info-box">
                    <a>
                        <span class="info-box-icon bg-green"><i class="fas fa-rupee-sign"></i></span>
                        <div class="info-box-content">
                            <span
                                class="info-box-text"><?php echo "Cash Income" //$this->lang->line('today_cash_income');                                      ?></span>
                            <span class="info-box-number"><?php
if (!empty($cash_income)) {
        echo $currency_symbol . $cash_income;
    } else {
        echo "0";
    }
    ?></span>
        ...
        ?>
                <div class="info-box">
                    <a href="<?php echo base_url() . "admin/staff" ?>">
                        <span class="info-box-icon bg-green"><i class="fas fa-user-secret"></i></span>
                        <div class="info-box-content">
                ...
                <div class="row">
                    <form role="form" id="addevent_form" method="post" enctype="multipart/form-data" action="">
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('event_title'); ?></label><span
                                class="req"> *</span>
                    ...
                    <form role="form" method="post" id="updateevent_form" enctype="multipart/form-data" action="">
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" name="title"
                                placeholder="<?php echo $this->lang->line('event_title') ?>" id="event_title">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('description') ?></label>
                            <textarea name="description" class="form-control"
                                placeholder="<?php echo $this->lang->line('description') ?>" id="event_desc"></textarea>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('event_date') ?></label>
                            <div class="input-group">
...
?>
                        ...
                        <div class="col-lg-12 modal-footer pb0">
                            <div class="pull-right">
                                <input type="submit" class="btn btn-primary submit_update"
                                    value="<?php echo $this->lang->line('save'); ?>">
...
if ($this->rbac->hasPrivilege('yearly_income_expense_chart', 'can_view')) {
    ...
    addData(datas);
    var labe = ['<?php echo $this->lang->line('opd') ?>', '<?php echo $this->lang->line('ipd') ?>' //,
        //'<?php //echo $this->lang->line('pharmacy') ?>', '<?php //echo $this->lang->line('pathology') ?>',
        //'<?php //echo $this->lang->line('radiology') ?>', '<?php //echo $this->lang->line('blood_bank') ?>',
        //'<?php //echo $this->lang->line('ambulance') ?>', '<?php //echo $this->lang->line('income') ?>'
    ];
    /* donut chart */
    var config2 = {
        type: 'doughnut',
