...
<div class="row">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <select class="form-control select2" style="width: 100%" name='radiology_category_id'>
                            <option value="<?php echo set_value('radio_category_id'); ?>">
    ...
    <div class="col-md-12">
        <table class="table table-striped table-bordered table-hover mb0" id="tableID">
            ...
            <tr id="row0">
                ...
                <td width="35%">
                    <select class="form-control select2 radiology_parmeter" style="width:100%" id="parameter_name_1"
    ...
    ?>
                ...
                <td width="30%">
                    <input type="text" readonly="" name="reference_range_1" id="reference_range_1"
