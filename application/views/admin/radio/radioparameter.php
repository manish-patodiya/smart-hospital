    ...
    ?>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="<?php echo base_url(); ?>admin/lab/delete_parameter/<?php echo $parameter['id'] ?>"
                                                class="btn btn-default btn-xs" data-toggle="tooltip"
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" action="<?php echo site_url('admin/lab1/addparameter') ?>" id="employeeform"
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/lab1/addparameter') ?>" name="employeeform"
