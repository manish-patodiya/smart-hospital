...
class Customlib
{
    ...
    public function getPatientAge($year, $month, $day)
    {
    ...
    public function getBedTime($month, $day, $hour, $mins)
    {
        $time = "";

        if ($month != 0) {
            $time .= $month . ' ' . $this->CI->lang->line('month') . ' ';
        }

        if ($day != 0) {
            $time .= $day . ' ' . $this->CI->lang->line('days') . ' ';
        }
    ...
    public function getblood_bank_type($id = null)
    {
        $type = array(
            '1' => 'Blood Group',
            '2' => 'Component',
    ...
    public function getMedicine_expire_month($date)
    {
    ...
    public function chargeTypeModule()
    {
        ...
        $charge_type_module["lab"] = $this->CI->lang->line("lab");
