...
class Bed_model extends MY_Model
{
    ...
    {
        return $this->db->update("patient_bed_history", $bed_history, array("is_active" => "yes", "case_reference_id" => $bed_history['case_reference_id']));
    }
    ...
    public function getLastBed($case_reference_id)
    {
        return $this->db->select('*')->where('case_reference_id', $case_reference_id)->order_by('id', 'desc')->limit(1)->get('patient_bed_history')->row();
    }
}