...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <form id="add_partial_payment" action="<?php echo site_url('admin/labtest/partialbill') ?>"
...
foreach ($transaction as $transaction_key => $transaction) {
        ?>
            <tr>
                ...
                <td><a href='javascript:void(0)' data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>'
