            ...
            <li class="treeview <?php echo set_Topmenu('IPD_in_patient'); ?>">
                <a href="<?php echo base_url() ?>admin/patient/ipdsearch">
                    <i class="fas fa-procedures" aria-hidden="true"></i> <span>
                        <?php echo $this->lang->line('ipd_in_patient'); ?></span>
                </a>
            </li>
            <?php
}
...
if ($this->module_lib->hasActive('radiology')) {
    if ($this->rbac->hasPrivilege('radiology_test', 'ca_view')) {
        ?>
...
?>
            <?php
if ($this->module_lib->hasActive('lab')) {
    if (($this->rbac->hasPrivilege('lab_test', 'can_view')) ||
        ($this->rbac->hasPrivilege('lab_bill', 'can_view'))) {
        ?>
            <li class="treeview <?php echo set_Topmenu('lab'); ?>">
                <a href="<?php echo base_url() ?>admin/labtest/gettestreportbatch">
                    <i class="fas fa-microscope"></i> <span><?php echo $this->lang->line('lab'); ?></span>
                </a>
            </li>
            <?php
}
            ...
            ?>
                    <li class="<?php echo set_Submenu('admin/payroll/payrollreport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/payroll/payrollreport"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('payroll_month_report'); ?></a></li>
                    <?php
}
...
//         if ($this->module_lib->hasActive('inventory')) {
        ...
        //                 ?>
                    <!-- <li class="<?php //echo set_Submenu('Reports/additemreport'); ?>"><a
                            href="<?php //echo base_url(); ?>admin/item/additemreport"><i
                                class="fas fa-angle-right"></i>
...
if ($this->rbac->hasPrivilege('general_setting', 'can_view')) {
        ...
        ?>
                    <li class="<?php echo set_Submenu('admin/backup'); ?>"><a
                            href="<?php echo base_url(); ?>admin/admin/backup"><i
                                class="fas fa-angle-right"></i>Backup</a>
                    </li>
    ...
    if ($this->module_lib->hasActive('ipd')) {
        if ($this->rbac->hasPrivilege('package', 'can_view')) {
            ?>
                    <li class="<?php echo set_Submenu('packages'); ?>"><a
                            href="<?php echo base_url(); ?>admin/packages"><i class="fas fa-angle-right"></i>
    ...
    if ($this->module_lib->hasActive('radiology')) {
        if ($this->rbac->hasPrivilege('radiology_category', 'can_view') || $this->rbac->hasPrivilege('radiology_unit', 'can_view') || $this->rbac->hasPrivilege('radiology_parameter', 'can_view')) {
            ?>
                    <li class="<?php
// prd(set_Submenu('addlab/index'));
            echo set_Submenu('addlab/index'); ?>"><a href="<?php echo base_url(); ?>admin/lab/addlab"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('radiology'); ?></a></li>
                    <?php
}
        if ($this->module_lib->hasActive('lab')) {
            if ($this->rbac->hasPrivilege('addlab', 'can_view') || $this->rbac->hasPrivilege('lab_unit', 'can_view') || $this->rbac->hasPrivilege('lab_parameter', 'can_view')) {
                ?>
                    <li class="<?php
echo set_Submenu('addlab/index'); ?>"><a href="<?php echo base_url(); ?>admin/labparameter/addlab"><i
                                class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('lab'); ?></a></li>
                    <?php
}
        }
    }
    ...
    if ($this->rbac->hasPrivilege('setting', 'can_view')) {?>
                    <li class="<?php echo set_Submenu('conference/zoom_api_setting'); ?>"><a
                            href="<?php echo base_url('admin/zoom_conference'); ?>"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('zoom_setting') ?></a></li>
                    <?php }
    ...
    if ($this->rbac->hasPrivilege('custom_fields', 'can_view')) {
        ?>
                    ...
                    <li class="<?php echo set_Submenu('customfield/index'); ?>"><a
                            href="<?php echo base_url(); ?>admin/customfield"><i class="fas fa-angle-right"></i>
                            <?php echo $this->lang->line('custom_fields'); ?></a>
                    </li>
                    <?php }?>
                </ul>
